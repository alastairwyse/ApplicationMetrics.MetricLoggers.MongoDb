...
{
    public class DiskReadOperation : CountMetric
    {
    ...
    public class AvailableMemory : StatusMetric
    {
    ...
    public class ActiveWorkerThreads : StatusMetric
    {
    ...
    public class DiskReadTime : IntervalMetric
    {
